      ...
      <div className="wrap">
        <div className="reveal" style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            <span className="years-in-tech" style={{ color: '#f4f1ec' }}>13</span> years hands-on across the startup ecosystem — designing customer experiences, shaping product strategy, and shipping software. I bring all of it to your business.
          </p>
        </div>
